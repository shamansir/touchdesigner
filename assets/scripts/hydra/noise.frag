...
//                 scale  -> parent().par.Scale
//                 offset -> parent().par.Offset
//
// NOTE: `offset` multiplies time -- it is the animation speed, not a phase.
//       Set offset = 0 to freeze the field for an A/B against hydra.
...
// --- verbatim from hydra utility-functions.js ------------------------------
//	Simplex 3D Noise
